...
export default async function UsedPage() {
  ...
  return (
    <div className="px-4 py-10 sm:px-8">
      <div className="mb-10 grid gap-6 border border-line bg-ink p-8 text-paper lg:grid-cols-[2fr_1fr]">
        <div>
        ...
        <div className="flex flex-col justify-center border-t border-paper/20 pt-6 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0">
          <span className="font-display text-5xl font-bold text-accent">
            {usd(totalSavings)}
          </span>
          <span className="label-mono mt-2 text-paper/50">
